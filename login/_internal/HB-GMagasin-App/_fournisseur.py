...
class Fournisseur:
    def __init__(self, root):
        ...
        reche_Option.place(x=600, y=80)
        self.ecri_recherche = Entry(self.root, textvariable=self.var_recherche, font=("times new roman",15), bg="lightyellow")
        self.ecri_recherche.place(x=850, y=80, height=40)

        #Bouton recherche et tous
        btn_recherche = Button(self.root, command=self.recherche, text="Recherche", font=("times new roman",15, ""), cursor="hand2", bg="blue",fg="white").place(x=1070, y=80, height=40)
        btn_tous = Button(self.root, command=self.affiche_resultat, text="Tous", font=("times new roman",15, ""), cursor="hand2", bg="lightgray",fg="black").place(x=1180, y=80, height=40)
        
        #Title 
        title = Label(self.root, text="Formulaire Fournisseur", font=("times new roman",30,"bold"), bg="cyan", fg="black").place(x=-100, y=0, width=1499)
        ...
        self.ecri_description.place(x=250, y=280, width=450, height=180)
        ...
        self.ajout_btn.place(x=50, y=500, width=150, height=40)
        ...
        self.modifier_btn.place(x=220, y=500, width=150, height=40)
        ...
        self.supprimer_btn.place(x=390, y=500, width=150, height=40)
        ...
        self.effacer_btn.place(x=560, y=500, width=150, height=40)


         #Liste Fournisseur
        liste_Frame = Frame(self.root, bd=3, relief=RIDGE)
        liste_Frame.place(x=720, y=150, width=550, height=450)
