...
class Categorie:
    def __init__(self, root):
        ...
        #contenu
        categorie = Label(self.root, text="Saisir Categorie Produit", font=("times new roman",30), bg="white").place(x=20, y=100)
        ecri_categorie = Entry(self.root, textvariable=self.var_nom, font=("times new roman",30), bg="lightyellow").place(x=20, y=160, width=320)
        ...
        self.ajout_btn.place(x=360, y=160, width=160, height=50)
        ...
        self.supprimer_btn.place(x=540, y=160, width=200, height=50)

         #Liste Categorie
        liste_Frame = Frame(self.root, bd=3, relief=RIDGE)
        liste_Frame.place(x=770, y=100, width=490, height=180)
        ...
        self.affiche_resultat()
         ...
         #Images
        self.cat1 = Image.open(r"C:\Users\HP\Desktop\Python_Projects\gestion_magasin\image\cat1.png")
        self.cat1 = self.cat1.resize((705,390))
        self.cat1 = ImageTk.PhotoImage(self.cat1)

        label_cat1 = Label(self.root, bd=7, relief=RAISED, image=self.cat1)
        label_cat1.place(x=20, y=230)

        self.cat2 = Image.open(r"C:\Users\HP\Desktop\Python_Projects\gestion_magasin\image\cat2.jpg")
        self.cat2 = self.cat2.resize((490,340))
        self.cat2 = ImageTk.PhotoImage(self.cat2)

        label_cat2 = Label(self.root, bd=7, relief=RAISED, image=self.cat2)
        label_cat2.place(x=760, y=280)
