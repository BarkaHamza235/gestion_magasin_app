...
class Produit:
    def __init__(self, root):
        ...
        produit_frame.place(x=10, y=10, width=650, height=620)
        ...
        reche_Frame.place(x=670, y=10, width=595, height=90)
        ...
        ecri_recher_option.place(x=10, y=10, width=170)

        ecri_recherche = Entry(reche_Frame, textvariable=self.var_ecri_recherche, font=("goudy old style",20), bg="lightyellow").place(x=190, y=10, width=200)

        #Bouton recherche et tous
        btn_recherche = Button(reche_Frame, command=self.recherche, text="Recherche", font=("times new roman",15, ""), cursor="hand2", bg="blue",fg="white").place(x=405, y=5, height=40)
        btn_tous = Button(reche_Frame, command=self.affiche_resultat, text="Tous", font=("times new roman",15, ""), cursor="hand2", bg="lightgray",fg="black").place(x=515, y=5, height=40)


        #Liste Produit
        liste_Frame = Frame(self.root, bd=3, relief=RIDGE)
        liste_Frame.place(x=665, y=120, width=600, height=509)
