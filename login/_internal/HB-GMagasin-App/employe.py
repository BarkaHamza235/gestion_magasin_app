...
class Employe:
    def __init__(self, root):
        ...
        reche_Frame.place(x=400, y=10, width=750, height=90)
        ...
        #Title 
        title = Label(self.root, text="Formulaire Employe", font=("times new roman",30,"bold"), bg="cyan", fg="black").place(x=-120, y=130, width=1499)

        #Contenu formulaire
        #ligne 1
        emp_id = Label(self.root, text="ID Employe", font=("goudy old style",20), bg="white").place(x=5, y=220, width=200)
        sexe = Label(self.root, text="Sexe", font=("goudy old style",20), bg="white").place(x=450, y=220, width=200)
        contact = Label(self.root, text="Contact", font=("goudy old style",20,), bg="white").place(x=850, y=220, width=200)
        
        self.ecri_emp_id = Entry(self.root, textvariable=self.var_emp_id, font=("goudy old style",20), bg="lightyellow")
        self.ecri_emp_id.place(x=180, y=220, width=250)
        ...
        ecri_sexe.current(0)
        ecri_sexe.place(x=630, y=220, width=250)
        ecri_contact = Entry(self.root, textvariable=self.var_contact, font=("goudy old style",20), bg="lightyellow")
        ecri_contact.place(x=1010, y=220, width=250)

        #ligne 2
        nom = Label(self.root, text="Nom", font=("goudy old style",20), bg="white").place(x=5, y=290, width=200)
        date_naiss = Label(self.root, text="Date Naiss", font=("goudy old style",20), bg="white").place(x=450, y=290, width=200)
        adhesion = Label(self.root, text="Adhesion", font=("goudy old style",20), bg="white").place(x=850, y=290, width=200)
        
        ecri_nom = Entry(self.root, textvariable=self.var_nom, font=("goudy old style",20), bg="lightyellow").place(x=180, y=290, width=250)
        ecri_date_naiss = Entry(self.root, textvariable=self.var_naissance, font=("goudy old style",20), bg="lightyellow").place(x=630, y=290, width=250)
        ecri_adhesion = Entry(self.root, textvariable=self.var_adhesion, font=("goudy old style",20), bg="lightyellow").place(x=1010, y=290, width=250)

        #ligne 3
        email = Label(self.root, text="E-mail", font=("goudy old style",20), bg="white").place(x=5, y=360, width=200)
        password = Label(self.root, text="Password", font=("goudy old style",20), bg="white").place(x=450, y=360, width=200)
        type = Label(self.root, text="Type", font=("goudy old style",20), bg="white").place(x=850, y=360, width=200)
        
        ecri_email = Entry(self.root, textvariable=self.var_email, font=("goudy old style",20), bg="lightyellow").place(x=180, y=360, width=250)
        ecri_password = Entry(self.root, textvariable=self.var_password, show="*", font=("goudy old style",20), bg="lightyellow").place(x=630, y=360, width=250)
        ...
        ecri_type.current(0)
        ecri_type.place(x=1000, y=360, width=250)

        #ligne 4
        adresse = Label(self.root, text="Adresse", font=("goudy old style",20), bg="white").place(x=5, y=430, width=200)
        salaire = Label(self.root, text="Salaire", font=("goudy old style",20), bg="white").place(x=450, y=430, width=200)
        
        self.ecri_adresse = Text(self.root, font=("goudy old style",20), bg="lightyellow")
        self.ecri_adresse.place(x=180, y=430, width=250, height=105)
        ecri_salaire = Entry(self.root, textvariable=self.var_salaire, font=("goudy old style",20), bg="lightyellow").place(x=630, y=430, width=250)
